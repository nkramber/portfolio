...
3. **OQ-3. The bio.** The owner writes the text of the About section (D-28). Blocks the About section pull request. Recommendation: two to four sentences in the plain and direct voice. On 2026-09-14, D-94 sets the method: an interview, then drafts from the answers alone. The question stays open until the owner approves the words.
...
8. **OQ-8. The logos.** Each card can show a logo beside its title (D-133). The owner gives one image file for each project, or the card shows no logo. Blocks nothing at launch. Recommendation: one square file with an opaque ground, because no browser recolors an image. The audit of PR-17 measured the fixture logo against the page. It reads 6.49:1 in light, 2.81:1 in dark, and 3.10:1 on forced black. A mark with a transparent ground and dark ink disappears in the dark scheme.
