...
| D-30 | 2026-09-12 | Stack | Astro 7 static output. A content collection with a schema holds the project entries, and the Astro image components serve the screenshots. | Astro 7 needs Node 22.12 or newer (read 2026-09-12). The stack pull request pins the Node version. |
