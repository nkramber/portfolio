...
The GNU General Public License version 3 in `LICENSE` covers the source code (D-146). It does not cover the text, photos, screenshots, or logos of the site. Those stay © 2026 Nate Kramber, all rights reserved.
